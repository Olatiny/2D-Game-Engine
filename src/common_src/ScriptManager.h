...
class ScriptManager
{
    ...
    public:
		...
		/**
		 * Run a single function in a script in the given context
		 */
		void runFunction(std::string script_id, std::string function_name, int argc, v8::Local<v8::Value> argv[], bool reload=RELOAD, std::string context_name="default");
