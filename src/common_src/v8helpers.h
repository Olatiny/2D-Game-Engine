...
namespace v8helpers
{
	...
	v8::Local<v8::Object> exposeToV8(int object_name, R *object_ref, std::vector<ParamContainer<G, S>> list_of_params, v8::Isolate *isolate, v8::Local<v8::Context> &context, std::string context_name="default")
	{
#if V8H_DEBUG
		...
		context->Global()->Set(v8::String::NewFromUtf8(isolate, std::to_string(object_name).c_str()), object);
